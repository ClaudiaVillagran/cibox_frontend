...
• Dirección de entrega (calle, número, comuna, región).
• Historial de pedidos y productos adquiridos.
• Preferencias de entrega.

Datos de pago:
• CIBOX no almacena datos de tarjetas de crédito o débito. Los pagos son procesados directamente por Webpay Plus (Transbank), plataforma certificada PCI-DSS.
...
• Coordinar el despacho y entrega de productos.
...
• Enviar notificaciones push sobre el estado de sus pedidos y novedades de CIBOX.
...
• Ejecución de un contrato: cuando el tratamiento es necesario para procesar su compra, gestionar su cuenta o coordinar el despacho.
...
• Consentimiento del titular: para el envío de comunicaciones comerciales y notificaciones opcionales.`,
  },
  {
    ...
    content: `CIBOX no vende, arrienda ni cede sus datos personales a terceros con fines comerciales propios.

Sus datos podrán ser compartidos únicamente con:

Operadores logísticos y empresas de despacho:
• Para coordinar la entrega de sus pedidos. Solo se comparten los datos estrictamente necesarios (nombre, dirección, teléfono de contacto).

Plataformas de procesamiento de pagos:
• Webpay Plus (Transbank), quien procesa las transacciones bajo sus propias políticas de seguridad y privacidad.
...
Todos los terceros con quienes compartimos datos están obligados a tratarlos de forma confidencial y solo para los fines autorizados.`,
  },
  {
    ...
    icon: "globe-outline",
    content: `Algunos de nuestros proveedores tecnológicos pueden estar ubicados fuera de Chile (por ejemplo, servicios de infraestructura cloud). En estos casos, CIBOX exige contractualmente que dichos proveedores apliquen medidas de protección equivalentes a las exigidas por la legislación chilena.
...
• Datos de cuenta activa: mientras mantenga su cuenta registrada en CIBOX.
...
CIBOX responderá dentro de un plazo razonable y a más tardar en 15 días hábiles.`,
  },
  {
    roman: "IX",
    title: "Seguridad de los Datos",
    icon: "lock-closed-outline",
    content: `CIBOX implementa medidas técnicas y organizativas para proteger sus datos personales frente a accesos no autorizados, pérdida, destrucción o divulgación indebida, incluyendo:
...
En caso de una brecha de seguridad que afecte sus datos, CIBOX le notificará a la brevedad posible conforme a la normativa aplicable.`,
  },
  {
    roman: "X",
    title: "Cookies y Tecnologías de Seguimiento",
    icon: "information-circle-outline",
    content: `La versión web de CIBOX puede utilizar cookies y tecnologías similares para:
...
La aplicación móvil no utiliza cookies, pero puede recopilar datos de uso de forma similar a través del sistema operativo del dispositivo.`,
  },
  {
    ...
    icon: "people-outline",
    content: `Los servicios de CIBOX están dirigidos a personas mayores de 18 años. No recopilamos intencionalmente datos personales de menores de edad.
...
Si tomamos conocimiento de que hemos recopilado datos de un menor sin autorización, procederemos a eliminarlos a la brevedad.`,
  },
  {
    ...
    content: `La aplicación móvil de CIBOX puede enviar notificaciones push a su dispositivo para informarle sobre:

• El estado de sus pedidos (confirmación, despacho, entrega).
...
Puede activar o desactivar las notificaciones push en cualquier momento desde la configuración de su dispositivo o desde las preferencias de su cuenta en la app, sin que ello afecte la prestación del servicio principal.`,
  },
  {
    ...
    icon: "create-outline",
    content: `CIBOX podrá modificar esta Política de Privacidad en cualquier momento para adaptarla a cambios legislativos, jurisprudenciales o a modificaciones en nuestros servicios.
          ...
          <View style={{ flex: 1 }}>
            ...
            <AppText style={{ fontSize: 12, color: colors.muted, lineHeight: 18 }}>
              ...
              <AppText
                ...
                onPress={() => Linking.openURL("mailto:contacto@cibox.cl")}
              >
                contacto@cibox.cl
              </AppText>
            </AppText>
