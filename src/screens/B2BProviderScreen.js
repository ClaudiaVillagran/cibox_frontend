...
// ─── Paleta B2B (verde CIBOX original del HTML) ────────────────────────────
const G = "#38B27B";
const G2 = "#3CC18E";
...
const META = [
  ...
  { label: "Web", value: "www.cibox.cl", url: "https://www.cibox.cl" },
    ...
    cards: [
      {
        ...
        items: [
          ...
          "Venta directa a CIBOX — comercialización B2C por CIBOX.",
        ],
      },
      {
        icon: "trophy-outline",
    ...
    cards: [
      {
        ...
        items: [
          "Pago Win/Win: 24 hrs con precios preferenciales para CIBOX.",
          "Pago fast: 72 hrs.",
      ...
      },
      {
        ...
        items: [
          "NDA formalizado.",
          "No venta directa a base de clientes CIBOX.",
      ...
      },
      {
        ...
        title: "F. Categoría y Margen CIBOX",
        items: [
          ...
          "Desarrollo de Cajas Exclusivas CIBOX.",
        ],
      },
    ],
    cta: {
      title: "¿Listos para avanzar?",
      body: "Escríbenos a contacto@cibox.cl para iniciar la formalización.",
      ...
      {email && (
        <Pressable
          onPress={() => Linking.openURL(
            `mailto:${email}?subject=Formalización Proveedor B2B CIBOX`
          )}
          style={({ pressed }) => ({
...
export default function B2BProviderScreen({ navigation }) {
    ...
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: 32 }}>
        ...
        <AppText style={{ fontSize: 13, color: colors.muted, textAlign: "center", lineHeight: 20 }}>
          Esta página está disponible en{"\n"}app.cibox.cl/ciboxpresentation
        </AppText>
      </View>
    );
  }
  ...
  const showBackBtn = false; // en web no se necesita botón volver
    ...
    <ScreenContainer maxWidth={760} padded={false}>
      ...
      {showTopBar && (
        <View style={{
          ...
          <Pressable
            onPress={() => Linking.openURL("https://www.cibox.cl")}
            style={{ flexDirection: "row", alignItems: "center", gap: 6 }}
          >
            <AppText style={{ fontSize: 13, color: G, fontWeight: "700" }}>www.cibox.cl</AppText>
      ...
      >
        ...
        {showBackBtn && (
          ...
          <AppText style={{ fontSize: 13, color: "rgba(255,255,255,.92)", lineHeight: 20, marginBottom: 24 }}>
            Modalidad <AppText style={{ fontWeight: "800", color: "#fff" }}>Proveedor B2B</AppText> — Venta directa a CIBOX y comercialización B2C por CIBOX.
          </AppText>
        ...
        <View style={{ paddingHorizontal: spacing.md, paddingTop: spacing.lg }}>
          ...
          <View style={{
            ...
            <AppText style={{ fontSize: 11, color: colors.muted, lineHeight: 17 }}>
              ...
              Este documento resume los puntos clave a formalizar para estructurar la relación B2B con CIBOX.
            </AppText>
            <AppText style={{ fontSize: 11, color: colors.muted, marginTop: 6 }}>
              © 2026 CIBOX COMERCIALIZADORA SpA — www.cibox.cl
            </AppText>
          </View>
        </View>
      </ScrollView>
