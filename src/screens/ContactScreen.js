...
export default function ContactScreen({ navigation }) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const mailto = `mailto:soporte@cibox.cl?subject=${encodeURIComponent(subject || "Contacto desde CIBOX App")}&body=${encodeURIComponent(body)}`;
      await Linking.openURL(mailto);
      setForm({ name: "", email: "", subject: "", message: "" });
    } catch {
      showAppAlert("Error", "No se pudo abrir el cliente de correo. Escríbenos directamente a soporte@cibox.cl");
    } finally {
      setSending(false);
    }
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12, marginBottom: spacing.lg }}>
          <ContactCard
            ...
            title="WhatsApp"
            value="+569 91264828"
            onPress={() => Linking.openURL("https://wa.me/56991264828")}
          />
          <ContactCard
            icon="mail-outline"
            title="Email"
            value="soporte@cibox.cl"
          ...
          <ContactCard
            ...
            title="Instagram"
            value="@cibox.cl"
            onPress={() => Linking.openURL("https://instagram.com/cibox.cl")}
          />
        </View>
